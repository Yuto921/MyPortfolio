...
//テーブル作成
$sql="CREATE TABLE tb_mission_4_Yuto"//・・・・・・・・・・・・・・・・・・・テーブル作成
."("
."id INT not null auto_increment primary key,"//・・・・・・・・・・・・・・・・・・投稿番号（投稿ごとに1ずつ増える）(primary keyはなくてもいい）
."name char(32)," //・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・名前
."comment TEXT,"//・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・コメント
."date DATETIME,"//・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・投稿日時
."pass TEXT" //・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・パスワード
...
if(isset($_POST['button']) and empty($_POST['editnumber2'])){   //・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・送信ボタン押されhidden空の時
  ...
  //テーブルに投稿内容挿入
  $sql=$pdo->prepare("INSERT INTO tb_mission_4_Yuto(name, comment,date,pass)VALUES (:name,:comment,:date,:pass)");  //・・・・・・idは指定しない（idをauto_incrementにすればidの値指定しない時自動で振られる（連番で）ので）
...
//テーブルの中身確認
/*
$sql='SHOW CREATE TABLE tb_mission_4_Yuto';
$result=$pdo->query($sql);
foreach($result as $row){
 print_r($row);
} //foreach
...
if(isset($_POST['deletebutton'])){   //・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・削除ボタン押されたとき
 if(!empty($_POST['delnumber']) and !empty($_POST['pass_del'])){  //・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・番号とパスが送信された場合 
  ...
  /******データを取り出す******/
    $sql='SELECT*FROM tb_mission_4_Yuto'; //・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・selectで全てのデータを取り出す
    $results= $pdo->query($sql);
    foreach ($results as $row){  //・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・ループ処理(1つずつ取り出し）
     if($row['id']== $deleteNo and $row['pass']==$pass_del){ //・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・パスと投稿番号一致
     $id=$deleteNo;
     $sql="delete from tb_mission_4_Yuto where id=$id"; //・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・idが一致する投稿を削除
     $result=$pdo->query($sql);
...
if(isset($_POST['editnumber'])){      //・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・編集ボタン押されたとき
 if(!empty($_POST['editnumber']) and !empty($_POST['pass_edit'])){   //・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・編集番号とパスが送信されたとき
  ...
  /******データを取り出す******/
    $sql='SELECT*FROM tb_mission_4_Yuto'; //・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・selectで全てのデータを取得
    $results= $pdo->query($sql);
    foreach ($results as $row){  //・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・ループ処理（1つずつ取り出し)
...
if(isset($_POST['button'])){   //・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・送信ボタン押され時
 if(strlen($comment1)>0 and strlen($name1)>0 and !empty($_POST['editnumber2'])){ //・・・・・・・・・・・・・・・・・・・・・・・・・・・各欄が空白でない時
       ...
       $pdo=new PDO($dsn, $user, $password); //・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・接続
        ...
        /******データを取り出す******/
       $sql='SELECT*FROM tb_mission_4_Yuto'; //・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・selectですべてのデータを取得
       $results= $pdo->query($sql);
         foreach ($results as $row){  //・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・ループ処理(1つずつ取り出し)
             if($row['id']==$editNo2){  //・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・テキストボックスの値と投稿番号が一致する時
                ...
                $pasu=$pass_new;
                $sql="update tb_mission_4_Yuto set name='$nm', comment='$kome', date='$hidzuke', pass='$pasu' where id ='$id'"; //・・・・・・・・上書き
                $results=$pdo->query($sql);
              } //・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・if
          } //・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・foreach
...
<!--投稿フォーム-->
 ...
 <!--名前:-->
 <input type="text" name="name" placeholder="名前" value="<?php if(isset($_POST['editnumber'])){ echo $row['name'];} ?>"  /><br/>
 <!--コメント:-->
 <input type="text" name="comment"  placeholder="コメント" value="<?php if(isset($_POST['editnumber'])){ echo $row['comment'];} ?>"/ ><br/>
<!--パスワード:-->
  <input type="text" name="pass" placeholder="パスワード" value="<?php if(isset($_POST['editnumber'])){ echo $row['pass'];} ?>"/><br/>
<!-- 編集したい番号を表示-->
 <input type="hidden" name="editnumber2" value="<?php if(isset($_POST['editnumber'])){ echo $editNo;} ?>"/>
...
<!--削除フォーム-->
 <form method="post" action="mission_4(2).php">
 <!--削除対象番号:-->
<input type="number" name="delnumber" placeholder="削除対象番号" value=""><br/>
<!--パスワード:-->
 <input type="text" name="pass_del" placeholder="パスワード" value=""><br/>
...
<form method="post" action="mission_4(2).php">
<!--編集対象番号:-->
<input type="number" name="editnumber" placeholder="編集対象番号" value=""><br/>
<!--パスワード:-->
 <input type="text" name="pass_edit" placeholder="パスワード" value=""><br/>
...
$sql='SELECT*FROM tb_mission_4_Yuto'; //・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・・selectですべてのデータ取得
$results= $pdo->query($sql);
